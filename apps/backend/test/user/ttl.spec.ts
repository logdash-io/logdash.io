...
describe('UserTtlService', () => {
  ...
  it('removes user after threshold', async () => {
    ...
    const logMetricsBeforeRemoval =
      await bootstrap.models.logMetricModel.find();
    const metricRegisterEntriesBeforeRemoval =
    ...
    const metricRegisterEntriesAfterRemoval =
      await bootstrap.models.metricRegisterModel.find();
