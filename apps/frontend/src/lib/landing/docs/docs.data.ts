...
Similar to log metrics, custom metrics are stored with different accuracy (minute, hour, and day), with retention policies determined by your subscription plan.`,
    tables: {
      ...
      maximumNumberOfUniqueMetrics: metricsTables.maximumNumberOfUniqueMetrics,
    } as Record<TableType, Table>,
    outro: '',
    type: 'general',
  },
...
export const sdkDocs: SDKSection[] = [
  ...
  },
  {
    id: 'dotnet',
    title: 'C#/.NET SDK',
    docsPath: 'https://github.com/logdash-io/dotnet-sdk?tab=readme-ov-file',
    sections: [
      { id: 'logs', title: 'Logging', path: '#logging' },
      { id: 'metrics', title: 'Metrics', path: '#metrics' },
    ],
  ...
  },
  {
    id: 'go',
    title: 'Go SDK',
    docsPath: 'https://github.com/logdash-io/go-sdk?tab=readme-ov-file',
    sections: [
      { id: 'logs', title: 'Logging', path: '#logging' },
      { id: 'metrics', title: 'Metrics', path: '#metrics' },
    ],
  ...
  },
  {
    id: 'rust',
    title: 'Rust SDK',
    docsPath: 'https://github.com/logdash-io/rust-sdk?tab=readme-ov-file',
    sections: [
      { id: 'logs', title: 'Logging', path: '#logging' },
      { id: 'metrics', title: 'Metrics', path: '#metrics' },
    ],
