...
>
	...
	<p class="mb-4">
		Yet we, engineers, constantly battle with fragmented tools and
		overwhelming data noise, wasting precious development time and breeding
		frustration. Self-hosted solutions promise control but deliver
		maintenance nightmares and scaling headaches instead. That's why we
		built Logdash.
	</p>

	<p class="mb-4">
		We've aggregated our years of expertise into a simple, powerful tool
		that eliminates the hassle of self-hosted solutions to help you:
	</p>

	<ul class="mb-4 list-inside list-disc">
		<li>Gain clarity and confidence in your systems</li>
		<li>Get your observability up and running in minutes</li>
