...
<div
	...
	style="min-height: calc(var(--spacing) * 18)"
	class="ld-card-base relative flex h-full w-full items-center justify-between gap-2 rounded-xl"
>
	{#if editMode}
		<div
			...
			class={[
				'absolute top-1/2 flex h-full w-full -translate-y-1/2 items-center justify-between gap-2 rounded-xl pr-6 ring ring-transparent transition-colors',
				{
