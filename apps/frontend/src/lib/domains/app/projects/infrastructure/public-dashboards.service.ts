...
export class PublicDashboardsService {
  getPublicDashboards(clusterId: string): Promise<PublicDashboard[]> {
    return httpClient.get<PublicDashboard[]>(`/clusters/${clusterId}/public_dashboards`);
  }
  ...
  getPublicDashboardData(
    ...
    return httpClient.get<PublicDashboardData>(`/public_dashboards/${dashboardId}/data`, {
      params: {
        period,
      },
    });
