<script lang="ts">
  ...
  import ProjectContextMenu from '$lib/domains/app/projects/ui/ProjectsSwitcher/ProjectContextMenu.svelte';
  import ProjectCreator from '$lib/domains/app/projects/ui/ProjectsSwitcher/ProjectCreator.svelte';
  import ProjectHealthStatus from '$lib/domains/app/projects/ui/monitor-status/MonitorStatusBadge.svelte';
