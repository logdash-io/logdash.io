<script lang="ts">
  ...
  } from '$lib/domains/app/projects/application/public-dashboards/public-dashboard.state.svelte.js';
  import {
    SystemStatusHeader,
    DashboardTitle,
    MonitorCard,
    EmptyState,
    DashboardFooter,
  } from '$lib/domains/app/projects/ui/presentational/public-dashboard';
