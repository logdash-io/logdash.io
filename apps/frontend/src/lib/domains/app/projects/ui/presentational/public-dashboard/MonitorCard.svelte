<script lang="ts">
  ...
  import UptimeChart from '$lib/domains/app/projects/ui/presentational/public-dashboard/UptimeChart.svelte';
  import PingChart from '$lib/domains/app/projects/ui/presentational/public-dashboard/PingChart.svelte';
