...
export const cookiesPolicyDefinition: LegalDocumentDefinition = [
  ...
  },
  {
    ...
    list: [
      {
        title:
          'The following Cookies are used on the Platform and on the Service:',
        list: [
      ...
      {
        title:
          'The following types of cookies are used within this Platform or Service:',
        list: [
      ...
      {
        title:
          'The Controller hereby informs the User that it uses Google Analytics to collect and analyse aggregated information on the use of the Platform or the Service.',
      },
      {
        title:
      ...
      {
        title:
          'The Controller hereby informs that restrictions on the use of Cookies may affect certain functionalities available on the Platform or the Website.',
      },
    ],
  },
];
